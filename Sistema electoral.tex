...
Observamos que el reparto de escaños se mantiene igual que con la Ley D'Hondt. Sin embargo, ahora un escaño $"$cuesta$"$\hspace{0.2em} \console{\textbf{28201}}  votos. En esta configuración, el PP no ha estado tan cerca de arrebatarle un escaño a PODEMOS, y además el orden de obtención de los escaños cuarto y quinto se ha invertido.
	...
	\subsubsection{Método de Sainte-Laguë}
	
	Vamos a realizar una simulación de los resultados del 20D utilizando el método de Sainte-Laguë. El hemiciclo queda como sigue:
	
	\console{
		\begin{center}
			\begin{tikzpicture}
				\begin{scope}[yscale=1,xscale=-1]
	 		  		\pie[pos={6,0}, sum=700, after number=, radius=4, color={pp, psoe, podemos, ciudadanos, gray }, text=legend]{107/PP, 86/PSOE, 73/Podemos, 51/Ciudadanos, 33/Otros} 
				\end{scope}			\end{tikzpicture}
		\end{center}
	}
	
	Los partidos que obtuvieron representación parlamentaria:
	...
	\console {	
		\noindent\makebox[\textwidth]{%
				...
				\hline
					...
					Partido Popular\footnotemark & 107 & 123 & -16 \\ \hline
					Partido Socialista Obrero Español\footnotemark & 86 & 90 & -4 \\ \hline
					Podemos \footnotemark & 73 & 69 & +4 \\ \hline
					Ciudadanos-Partido de la Ciudadanía & 51 & 40 & +11 \\ \hline
					Unidad Popular: IU, Unidad Popular en Común & 8 & 2 & +6 \\ \hline
					Esquerra Republicana de Catalunya-Catalunya Sí & 8 & 9 & -1\\ \hline
					Democràcia i Llibertat & 7 & 8 & -1 \\ \hline
					Euzko Alderdi Jeltzalea-Partido Nacionalista Vasco & 5 & 6 & -1\\ \hline
					Euskal Herria Bildu & 3 & 2 & +1 \\ \hline
					Més & 1 & 0 & +1 \\ \hline
	...
	El partido más beneficiado sería Ciudadanos, que obtendría 11 escaños más. El más perjudicado, el PP que perdería 16. Izquierda Unida Unidad Popular hubiese obtenido 6 escaños más, llegando a los 8 y Més entraría en el parlamento con un escaño.
